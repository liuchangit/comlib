...
public class ServiceAddress {
	...
	@Deprecated
	public ConnectionGuard getConnection(int hash) {
		ConnectionGuard conn = pool.getConnection(hash);
	...
	public void fail(ConnectionGuard conn) {
		//do nothing, just keep api compatible
	}
	
	public void timeout(ConnectionGuard conn) {
		//do nothing, just keep api compatible
	}
